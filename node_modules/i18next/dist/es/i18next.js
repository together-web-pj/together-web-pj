  ...
  I18n.prototype.init = function init(options, callback) {
    ...
    if (!this.options.isClone) {
      (function () {
        ...
        var lu = new LanguageUtils(_this2.options);
        ...
        s.backendConnector = new BackendConnector(createClassOnDemand(_this2.modules.backend), s.resourceStore, s, _this2.options);
        ...
        s.cacheConnector = new CacheConnector(createClassOnDemand(_this2.modules.cache), s.resourceStore, s, _this2.options);
        // pipe events from backendConnector
